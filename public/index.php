<?php 
  ...
  $usuarioLogado = isset($_SESSION['user_name']) ? $_SESSION['user_name'] : null;
?>
...
<button class="btn-agendar" onclick="window.location.href='<?= isset($_SESSION['user_id']) ? BASE_URL . "public/agendamento.php" : BASE_URL . "user/login.php" ?>'">
    AGENDAR
</button>
